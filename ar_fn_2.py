...
def check_user_d(a,b,c):
    ...
    if a[i]=='x' and b[i+1]=='x' and c[i+2]!='x' and c[i+2]!='o':
        ...
        return -1
def check_special_corner(a,b,c):
...
def check_according_me(a,b,c,according_me):
    for i in according_me:
        if i<3:
            if a[i]!='x' and a[i]!='o':
                a[i]='o'
                break
